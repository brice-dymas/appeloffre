...
<tiles:insertDefinition name="layout">
    <tiles:putAttribute name="body">
        <div class="row">
            <div class="col-md-12">
                <h4>
                    <spring:message code="materiel.nouveau" />
                </h4>
                <hr/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <spring:url value="/materiel/create" var="materiel_create"
                            htmlEscape="true" />
                <form:form method="post" commandName="materiel" action="${materiel_create}">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            ...
                            <spring:url value="/materiel/" htmlEscape="true"
                                        var="materiel_home" />
                            <a href="${materiel_home}" class="btn btn-danger btn-sm">
