...
<tiles:insertDefinition name="layout">
    <tiles:putAttribute name="body">
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <spring:message code="appelOffre.modifier" />
                </h3>
                <hr>
            </div>
        </div>

        <spring:url value="/appeloffre/update" var="appeloffre_update"
                    htmlEscape="true" />
        <form:form method="post" commandName="appelOffreForm" action="${appeloffre_update}?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data" >
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <form:errors  cssClass="text-danger" path="appelOffre.numero"/>
                        <form:hidden id="id" path="appelOffre.id"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend>
                            <spring:message code="appelOffre.listeMateriel" />
                        </legend>
                                        ...
                                        <c:forEach items="${appelOffreForm.ligneAppels}" varStatus="status" begin="0">
                                            ...
                                            <tr class="list-materiel">
                                                ...
                                                <td>
                                                    ...
                                                    <spring:bind path="ligneAppels[${status.index}].id">
                                                        <form:hidden path="${status.expression}" cssClass="text-danger" />
                                                    </spring:bind>
                                                </td>
                                                <td class="row-align">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <fieldset>
                        <legend>
                            <spring:message code="appelOffre.cautions" />
                        </legend>
                        <div id="caution">
                            <table class="table table-bordered">
                                <thead>
                                        ...
                                        <c:forEach items="${appelOffreForm.cautions}" varStatus="status" begin="0">
                                            ...
                                            <tr class="list-caution">
                                                ...
                                                <td>
                                                    ...
                                                    <spring:bind path="cautions[${status.index}].id">
            ...
            <form:hidden path="appelOffre.id"/>
            <div class="row">
                <div class="col-md-12">
                    <hr/>
